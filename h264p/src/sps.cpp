...
static const u_char ZZ_SCAN[16] =
{ 0,  1,  4,  8,  5,  2,  3,  6,  9, 12, 13, 10,  7, 11, 14, 15
};

static const u_char ZZ_SCAN8[64] =
...
static void Scaling_List(int* scalingList, int sizeOfScalingList, bool* UseDefaultScalingMatrix, Bitstream* s)
{
	int j, scanj;
