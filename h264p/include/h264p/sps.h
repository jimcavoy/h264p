...
constexpr unsigned int MAXnum_ref_frames_in_pic_order_cnt_cycle = 256;
constexpr unsigned int MAXIMUMVALUEOFcpb_cnt = 32;
...
namespace ThetaStream
{
    ...
    /// @brief NALUnitSPS represents a Sequence parameter set RBSP syntax as defined in 
    /// ISO/IEC 14496-10, Section 7.3.2.1, page 40
    class NALUnitSPS
        : public NALUnitImpl
    {
    public:
