...
namespace ThetaStream
{
    ...
    /// @brief Supplemental Enhancement Information (SEI) Base Implementation Class
    class SEIimpl
    ...
    /// @brief SEIDefault represents all the other SEI types that are not SEIPicTiming or 
    /// SEIUserDataUnreg
    class SEIDefault
        : public SEIimpl
    {
    ...
    /// @brief SEIPicTiming represents a Picture timing SEI message as defined in 
    /// ISO/IEC 14496-10, Annex D, D.1.2, page 344
    class SEIPicTiming
        : public SEIimpl
    {
    public:
    ...
    private:
        void Interpret(ThetaStream::Bitstream* bitstream);
    ...
    public:
        ...
        RawByteStreamPayload rbsp_; ///< Raw Byte Stream Payload
    };

    /// @brief SEIUserDataUnreg represents User data unregistered SEI message syntax defined in
    /// ISO/IEC 14496-10, Annex D, D.1.6, page 346
